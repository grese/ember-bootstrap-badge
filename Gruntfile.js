module.exports = function(grunt) {
    ...
    emberTemplates: {
      options: {
        templateName: function(sourceFile) {
          ...
          return 'ember-bootstrap-badge-template-' + template;
        }
      },
  ...
  grunt.registerTask('default', ['jshint', 'clean', 'concat:build', 'concat:dist', 'uglify', 'copy:css']);
  // test task builds, tests, and then dists the package.
  grunt.registerTask('test', ['jshint', 'clean', 'concat:build', 'karma', 'concat:dist', 'uglify', 'copy:css']);
};